  ...
  <div id="top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light nav-item">
      <router-link class="navbar-brand" to="/home">
        <img src="https://s3.amazonaws.com/designmantic-logos/logos/2020/Jan/small-1927-5e25454e1df25.png" style="width: 50px;" alt/>
      </router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav text-center nav-text">
          <li>
            <router-link class="nav-color nav-link text-bold hvr-bob" to="/home">首頁</router-link>
          </li>
          <li>
            <router-link class="nav-color nav-link text-bold hvr-bob"
            to="/productlist">產品</router-link>
          </li>
          <li>
            ...
            <li class="d-flex justify-content-end">
              ...
              <div class="dropdown">
                <button class="btn" type="button" id="dropdownMenu" data-toggle="dropdown"
                  aria-haspopup="true" aria-expanded="false" style="padding-right: 0px;">
                ...
                <table class="dropdown-menu dropdown-menu-right dropItem table pt-2"
                  ...
                  v-if="isFavShow == false" style="font-size: 18px">
                  目前沒有任何收藏
                  </span>
                  <button class="btn btn-coffee text-white mx-auto d-block mb-4"
                  v-if="isFavShow == false" @click.prevent="goProduct">
                  收藏產品去
                  </button>
                  <tbody>
              ...
              <div class="dropdown">
                ...
                <table class="dropdown-menu dropdown-menu-right dropItem table pt-2 px-1"
                  ...
                  <button class="btn btn-coffee text-white mx-auto d-block mt-4"
                  v-if="isCartShow == false" @click.prevent="goProduct">
                    購買產品去
                  </button>
                  <thead class="text-coffee" v-if="isCartShow">
                    <th class="align-middle bt-0" style="width: 50%">名稱</th>
                    <th class="align-middle p-0 bt-0" style="width: 20%">人數</th>
                    <th class="align-middle bt-0" style="width: 20%">價格</th>
                    <th class="align-middle bt-0" style="width: 10%">刪除</th>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      <td colspan="2" class="text-right text-bold text-coffee"
                       v-if="isCartShow">
                       總計
                      </td>
...
export default {
  ...
  methods: {
    getCart() {
      ...
      vm.$http.get(api).then((response) => {
        ...
        vm.$bus.$emit('updateCountTotal', this.countTotal);
  ...
  mounted() {
    ...
    vm.$bus.$on('updateSameCart', (id, qty) => {
      vm.addCart(id, qty);
    });
